@PostMapping("/E_commerceOwnerlogin")
public Map Ownerlogin(HttpServletRequest req)throws ClassNotFoundException, SQLException
{
	...
	String query = "select * from E_commerceOwnerdetails where username='"+username+"'" ;
