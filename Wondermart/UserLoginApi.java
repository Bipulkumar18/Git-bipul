@PostMapping("/E_commerceUserlogin")
public Map Userlogin(HttpServletRequest req)throws ClassNotFoundException, SQLException
{
	...
	String query = "select * from E_commerceUserdetails where username='"+username+"'" ;
