...
public Map updateuser(HttpServletRequest req)throws ClassNotFoundException, SQLException, IOException
{
	...
	String query = "select username,password from E_commerceUserdetails where username='"+username+"' and password ='"+password+"'";
	...
	else 
	{
		...
		String queryInsert="update E_commerceUserdetails set password= ? where username = ?"; 
